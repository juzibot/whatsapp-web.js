...
const { ClientInfo, Message, MessageMedia, Contact, Location, UrlLink, ProductMessage, GroupNotification, Label, Call, Buttons, List, Reaction, Poll } = require('./structures');
